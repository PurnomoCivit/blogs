...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="assets/template/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="sign-in"><b>Blogs</b>Management</a>
  </div>
  <!-- /.login-logo -->
...
<!-- jQuery 3 -->
<script src="assets/template/jquery/dist/jquery.min.js"></script>
<!-- Bootstrap 3.3.7 -->
<script src="assets/template/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- iCheck -->
<script src="assets/template/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
